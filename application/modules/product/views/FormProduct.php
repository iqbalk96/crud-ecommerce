    ...
    <main class="content flex-fill">
        ...
        <section class="d-flex flex-column gap-4">
            <div class="d-flex justify-content-between align-items-center gap-3">
                <h4 class="title-section-content">Create Product</h4>
            </div>
            <div class="card">
                <div class="card-body">
                    <div>
                        <form enctype="multipart/form-data" action="<?php echo base_url('product/create_product') ?>" method="post">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="product_name" class="form-label">Product name</label>
                                    <input type="text" required class="form-control" name="nama" id="product_name" placeholder="eg: Louis Vouton">
                                </div>
                                <div class="col-6 mb-3">
                                    <label for="harga_beli" class="form-label">Purchase price</label>
                                    <input type="number" min="0" required class="form-control" name="harga_beli" id="harga_beli" placeholder="eg: 150000">
                                </div>
                                <div class="col-6 mb-3">
                                    <label for="harga_jual" class="form-label">Selling price</label>
                                    <input type="number" min="0" required class="form-control" name="harga_jual" id="harga_jual" placeholder="eg: 200000">
                                </div>
                                <div class="col-6 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="file" required class="form-control" name="image" id="image" accept="image/png, image/gif, image/jpeg" >
                                </div>
                                <div class="col-12 mb-3">
