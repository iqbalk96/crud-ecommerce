    ...
    <main class="content flex-fill">
        ...
        <section class="d-flex flex-column gap-4">
            <div class="d-flex justify-content-between align-items-center gap-3">
                <h4 class="title-section-content">Exclusive Product Terralogic</h4>
                <a href="<?= base_url('product/create') ?>" class="btn-link">Create Product</a>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <?php echo $this->load->view('./ProductList.php') ?>
                    </div>
                </div>
            </div>
